 ...
 */
class UserDetailsModelToUserFavoriteEntityMapper : BaseMapper<UserDetailsModel, UserFavoriteEntity>() {

    override fun map(value: UserDetailsModel): UserFavoriteEntity {
